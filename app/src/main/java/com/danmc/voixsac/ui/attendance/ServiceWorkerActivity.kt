...
class ServiceWorkerActivity : AppCompatActivity() {
    ...
    private fun updateData(){
        ...
        val fecha = binding.edApellido.text.toString()
        val hora = binding.edCorreo.text.toString()
        val ubicacion = binding.edContrasena.text.toString()
        val estado = binding.edRol.text.toString()
        val dni = binding.edDni.text.toString()
        val trabajadores = Asistencias(id=nombre, fecha = fecha, hora = hora, ubicacion = contrasena, dni = dni, rol = rol)
